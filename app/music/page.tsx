                                ...
                                .map((track, idx) => (
                                    ...
                                    >
                                        <div className="rounded-lg border border-white/10 bg-black/30 px-5 py-4">
                                            ...
                                            {track.linerNotes && (track.linerNotes.personalContext || track.linerNotes.scriptureReferences?.length) && (
                                                <>
                                                    ...
                                                    <div className="space-y-4">
                                                        {track.linerNotes.personalContext && (
                                                            <div>
                                                                <p className="text-xs tracking-[0.2em] text-yellow-500/50 uppercase mb-2">Composer's Note</p>
                                                                <p className="text-sm text-white/55 leading-relaxed italic">{track.linerNotes.personalContext}</p>
                                                            </div>
                                                        )}
                                                        {track.linerNotes.scriptureReferences?.length && (
                                                            <div className="flex items-center gap-2 flex-wrap">
                                                                <p className="text-xs tracking-[0.2em] text-yellow-500/50 uppercase">Scripture</p>
                                                                {track.linerNotes.scriptureReferences.map((ref, i) => (
                                                                    <span key={i} className="text-xs border border-yellow-500/20 text-yellow-400/60 px-2 py-0.5 rounded-sm">
                                                                        {ref}
                                                                    </span>
                                                                ))}
                                                            </div>
