/* ==========================================================
   app/merch/kitchen/page.tsx — Kitchen & Cups collection grid
   Shows all Kitchen & Cups collections: Kitchen, Drinkware.
   ========================================================== */
...
export const metadata: Metadata = {
    title: "Kitchen & Cups — Hydromedon",
    description: "Kitchen & Cups from Hydromedon.",
};

// Exact Fourthwall collection slugs that belong to this category.
const KITCHEN_SLUGS = new Set(["artifacts-0-kitchen", "artifacts-0-drinkware"]);
...
export default async function KitchenPage() {
    ...
    try {
        ...
        entries = resolveMerchEntries(
            live.filter((c) => KITCHEN_SLUGS.has(c.slug)),
            [],
        );
    } catch (err) {
        console.error("[KitchenPage] Fourthwall API error:", err);
    }
        ...
        >
            ...
            <section className="relative max-w-6xl mx-auto px-6 pt-28 sm:pt-36 pb-16 sm:pb-24">
                ...
                <MerchGrid
                    entries={entries}
                    variant="artifact"
                    emptyLabel="No Kitchen & Cups items available yet."
                />
            </section>
        </main>
    );
