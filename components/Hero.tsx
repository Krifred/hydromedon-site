...
return (
  <section className="relative flex flex-col min-h-[88vh] pt-10 pb-10 text-center overflow-hidden">
    ...
    >
      <div className="relative flex items-center justify-center">
        ...
        <div
          aria-hidden
          className="pointer-events-none absolute left-1/2 top-1/2 -z-10 h-[1200px] w-[1200px]
                     -translate-x-1/2 -translate-y-1/2 rounded-full
                     bg-hero-halo blur-3xl animate-halo-pulse"
          style={{ opacity: fade }}
        />
        ...
        <Image
          ...
          className={`relative z-10 -translate-y-1 drop-shadow-[0_28px_70px_rgba(0,0,0,0.65)]
            ${isBreathing ? "animate-[hero-breathe_16s_ease-in-out_infinite]" : ""}
          `}
        />
      </div>
    ...
    <FadeIn delayMs={600} durationMs={1400} y={20}>
      <div className="mt-auto pt-6 sm:pt-8">
        <div className="flex justify-center gap-4">
          <a
            href="#music"
            className="h-11 px-7 py-2 bg-yellow-500 text-black rounded
                       shadow hover:bg-yellow-400 font-semibold transition"
          >
            Listen
          </a>
