...
export const releases: Release[] = [
    ...
    },
    {
        ...
        subtitle: "A Lament That Becomes a Victory",
        description: "\"Tears for Bread\" is a song born from nights of silence, questions, and the kind of prayers that feel like they disappear into the dark. Lines like \"My tears have been my bread each day\" and \"My soul is faint, my spirit weak\" came from real places — but so did the hope that rises in the final chorus: \"Closer than breath, in the dark You still shine.\"",
        themes: ["Longing for God", "Perseverance in faith", "God's nearness in darkness", "Transformation from brokenness to victory"],
        genres: ["dream-pop", "cinematic", "worship"],
        mood: "longing, quiet hope, faith-in-the-dark",
        bibleRef: "Psalm 42, Psalm 22, Isaiah 49:16, Psalm 46:10",
        bibleBook: "Psalms",
        storyPublished: false,
