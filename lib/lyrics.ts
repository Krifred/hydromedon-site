...
export type LyricsMap = {
    [releaseSlug: string]: {
        [trackTitle: string]: TrackLyrics;
    };
};

export const lyricsByRelease: LyricsMap = {
    "armor-of-light": {
        "Armor of Light": {
            lyrics: `
...
Covered in armor of the King
      `.trim(),
            linerNotes: {
                personalContext:
                    "This song was written during a season of spiritual warfare, when standing firm in faith felt less like confidence and more like endurance. It reflects the experience of learning to trust God’s protection not as an abstract idea, but as daily survival.",

                musicalChoices:
                    "The song unfolds slowly and deliberately, with a restrained tempo that mirrors perseverance rather than urgency. Cinematic pads and sustained chords create a sense of being surrounded, while the steady rhythmic pulse reinforces the idea of standing one’s ground.",

                thematicReflection:
                    "Armor of Light is not about aggression, but about remaining faithful in the midst of unseen battles. It draws from the imagery of Ephesians 6, framing faith not as force, but as steadfast trust in God’s presence and protection.",

                scriptureReferences: ["Ephesians 6:10–18"],

                writtenDuring: "A season of spiritual resistance and prayer",

                moodTags: ["resolute", "protective", "steadfast"],
            },
        },
    },
...
And walk in freedom, unashamed
      `.trim(),
            ...
            linerNotes: {
                personalContext:
                    "This song was written during a season of loss and quiet rebuilding, when grief had altered expectations and joy felt distant. It came from learning to hold sorrow honestly while still daring to believe that restoration was possible.",

                musicalChoices:
                    "The arrangement favors warmth and gradual movement rather than dramatic shifts. Gentle melodic arcs and layered harmonies were chosen to reflect healing as a process — slow, patient, and often imperceptible in the moment.",

                thematicReflection:
                    "Inspired by Isaiah 61, the song does not deny pain or rush toward resolution. Instead, it bears witness to the promise that God redeems what has been broken, allowing beauty to emerge without erasing the reality of loss.",

                scriptureReferences: ["Isaiah 61:1–3"],

                writtenDuring: "A season of grief, healing, and renewed hope",

                moodTags: ["healing", "hopeful", "restorative"],
            },
        },
    },
...
For Your glory, eternally
      `.trim(),
            ...
            linerNotes: {
                personalContext:
                    "This song was written during a season of deep self‑examination, when the desire for change was sincere but uncomfortable. It came from confronting personal failure and wrestling with the fear that true transformation might cost more than expected.",

                musicalChoices:
                    "The arrangement is intentionally restrained. Soft, steady rhythms and uncluttered harmonic movement create space for reflection, while gentle melodic repetition mirrors the slow, often repetitive nature of spiritual growth.",

                thematicReflection:
                    "Rather than declaring victory, the song remains in the posture of surrender. It is a prayer spoken before answers arrive — an acknowledgment that transformation is shaped over time, in the hands of God, rather than achieved through effort alone.",

                scriptureReferences: ["Jeremiah 18:1–6", "Psalm 51"],

                writtenDuring: "A season of repentance and inner renewal",

                moodTags: ["vulnerable", "surrendered", "reflective"],
...
Hope that glows where fears reside
      `.trim(),
            ...
            linerNotes: {
                personalContext:
                    "This song was written in a season marked by uncertainty and waiting — when forward movement felt stalled and the next step was unclear. It came from learning to trust God not for immediate answers, but for presence in the middle of unanswered prayers.",

                musicalChoices:
                    "The arrangement is built around steady, grounding rhythms and warm harmonic layers. Rather than dramatic shifts, the music unfolds patiently, reflecting the slow work of trust forming over time. Subtle dynamic builds mirror the quiet strengthening of faith rather than sudden breakthrough.",

                thematicReflection:
                    "Make a Way is not a demand for change, but a confession of dependence. It acknowledges human limits and places hope not in circumstances shifting quickly, but in God’s faithfulness to guide, sustain, and open paths in His time.",

                scriptureReferences: ["Isaiah 43:19", "Proverbs 3:5–6"],

                writtenDuring: "A season of waiting and unresolved prayer",

                moodTags: ["trusting", "patient", "hopeful"],
...
Thank You, Lord
      `.trim(),
            ...
            linerNotes: {
                personalContext:
                    "This song was written as a moment of stillness within the album — a place to stop striving, stop asking, and simply receive. It came from the desire to speak blessing rather than petition, and to rest in assurance rather than effort.",

                musicalChoices:
                    "The arrangement is intentionally minimal and reverent. Gentle melodic phrasing and unhurried pacing create a sense of quiet attentiveness, allowing the words to settle rather than build. The music avoids tension and resolution, mirroring the nature of a blessing that does not need to be earned or explained.",

                thematicReflection:
                    "Rooted in the priestly blessing of Numbers 6:24–26, this song functions as a benediction over the listener. It reframes faith not as pursuit, but as reception — a reminder that peace is given, not achieved, and that God’s favor rests.",

                scriptureReferences: ["Psalm 91", "Psalm 57:1"],

                writtenDuring: "A season of anxiety, prayer, and learning to rest",

                moodTags: ["safe", "restful", "trusting"],
...
Through valleys deep, You are my light
      `.trim(),
            ...
            linerNotes: {
                personalContext:
                    "This song was written during a season of anxiety and vulnerability, when the need for safety felt immediate and personal. It came from moments of seeking shelter — emotionally and spiritually — and learning to rest rather than remain constantly alert and guarded.",

                musicalChoices:
                    "The music is intentionally gentle and enveloping. Soft harmonic layers and unhurried pacing create a sense of being held, while minimal rhythmic movement reinforces stillness and rest. The arrangement avoids tension, allowing space for calm and reassurance to settle in.",

                thematicReflection:
                    "Under Your Wings reflects the biblical image of God as refuge — not as distance or abstraction, but as nearness and protection. It emphasizes trust over vigilance, inviting the listener to release fear and remain in God’s care rather than striving for control.",
...
In Your presence, Lord, I find my light
      `.trim(),
            ...
            linerNotes: {
                personalContext:
                    "This song was written in moments of mental exhaustion and anxiety, when peace felt theoretical rather than accessible. It came from practicing trust not by eliminating fear, but by returning again and again to prayer in the midst of it.",

                musicalChoices:
                    "The music is intentionally steady and uncluttered. Repetition and consistent rhythmic grounding were used to mirror the practice of redirecting the mind — gently, persistently — toward what is true and life‑giving.",

                thematicReflection:
                    "Drawing from Philippians 4, the song explores peace as a guarding presence rather than an emotional escape. It reflects the discipline of dwelling on what is good and true, even when circumstances remain unsettled.",

                scriptureReferences: ["Philippians 4:6–9"],

                writtenDuring: "A season of anxiety and spiritual re‑centering",

                moodTags: ["calming", "anchoring", "assured"],
...
And I will trust the fight to You
      `.trim(),
            ...
            linerNotes: {
                personalContext:
                    "This song was written during a time of confrontation and endurance, when injustice, accusation, or opposition felt overwhelming. It came from the need to stop defending oneself and instead entrust the outcome to God.",

                musicalChoices:
                    "Stronger rhythmic motion and rising melodic phrases were chosen to convey resolve without aggression. The music moves forward with confidence, reflecting trust in divine intervention rather than human control.",

                thematicReflection:
                    "Arise O Lord is a prayer of relinquishment rather than retaliation. It echoes the biblical pattern of calling on God to act justly, affirming that true deliverance comes not through force, but through surrender to God’s authority.",

                scriptureReferences: ["Psalm 3", "Psalm 68:1"],

                writtenDuring: "A season of conflict, prayer, and perseverance",

                moodTags: ["bold", "resolute", "trusting"],
